...
public class SetDir : StateMachineBehaviour
{
    private ShowArrow _sA;
    private DragRotation _dr;
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        //화살표 표시
        _sA = animator.GetComponent<ShowArrow>(); _sA.Show();
        
        //카메라 컨트롤 타입 드래그로 변경
        CameraController.instance.onControll = CameraController.ControllType.Drag;
        _dr = animator.GetComponent<DragRotation>();
        _dr.onControll = true;
